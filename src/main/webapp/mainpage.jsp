...
<textarea rows="10" cols="12">증권 차트1 호출부분</textarea>
									</div>
									<!--end col-->
								</div>
								<!--end row-->
...
<h4 class="card-title">증권 차트2</h4>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-12 col-md mb-2 mb-lg-0">
<textarea rows="10" cols="12">증권 차트2 호출부분</textarea>
									</div>
									<!--end col-->
								</div>
								<!--end row-->
					...
					<div class="col-lg-6">
						<div class="card">
							<div class="card-header">
								<div class="row align-items-center">
									<div class="col">
<h4 class="card-title">상위 10개 종목</h4>
									</div>
									<!--end col-->
								</div>
								<!--end row-->
							...
							<div class="card-body">
								<div class="row">
									<div class="col-12 col-md mb-2 mb-lg-0">
<textarea rows="10" cols="12">상위 10개 종목 호출부분</textarea>
									</div>
									<!--end col-->
								</div>
								<!--end row-->
